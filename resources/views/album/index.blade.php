...
<div class="container mx-auto p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow hover:shadow-lg transition p-4 flex flex-col">
            <img src="{{ asset('storage/' . $album->cover_image) }}" alt="Cover Album" class="w-full h-48 object-cover rounded mb-3">
        ...
        @empty
            <p class="col-span-full text-center text-gray-600">Belum ada album yang ditambahkan.</p>
        @endforelse
    </div>
</div>
@endsection
