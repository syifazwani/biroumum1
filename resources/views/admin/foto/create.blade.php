...
<head>
    ...
    <title>Tambah Foto - Admin Dashboard</title>
...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-6 flex-grow">
        <div class="max-w-3xl mx-auto p-6 rounded-xl shadow-lg bg-white mt-4">
            ...
            <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Tambah Foto</h1>
            ...
            <form action="{{ route('foto.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                ...
                <div>
                    <label for="file" class="block text-gray-700 font-semibold mb-2">Foto:</label>
                    <input type="file" name="file" id="file" required class="w-full">
                </div>
